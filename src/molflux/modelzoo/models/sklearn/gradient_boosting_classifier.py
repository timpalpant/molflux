...
_DESCRIPTION = """
This is an sklearn gradient boosting classifier model.
...
the loss function, e.g. binary or multiclass log loss. Binary classification is a
...
class GradientBoostingClassifierConfig(ModelConfig):
    loss: Loss = "log_loss"
...
class GradientBoostingClassifier(
    ...
    def _instantiate_model(self) -> SKGradientBoostingClassifier:
