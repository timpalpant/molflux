...
_DESCRIPTION = """
This is an sklearn K nearest neighbours regressor.
...
instances of the training data. Regression is computed from a simple majority vote
of the nearest neighbors of each point: a query point is assigned the average of the
...
class KNNRegressorConfig(ModelConfig):
    n_neighbors: int = 5
...
class KNNRegressor(SKLearnModelBase[KNNRegressorConfig]):
    ...
    def _instantiate_model(self) -> KNeighborsRegressor:
